...
# matched. Exit 0 iff compared > 0 and mismatch = 0.
set -u
...
attrs-a=$n_a attrs-b=$n_b null-a=$null_a null-b=$null_b common=$n_common compared=$n_picked matched=$matched mismatch=$mismatch"
